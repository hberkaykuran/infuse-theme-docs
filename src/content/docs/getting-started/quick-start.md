---
title: Quick start
description: Install Infuse, pick a style, and build your first page.
path: /docs/getting-started/quick-start
---

# Quick start

This guide takes you from a fresh install to a home page you can publish. It assumes you have a Shopify store and access to your admin. If you have not added the theme yet, start with [installation](/docs/getting-started/installation).
...
Select the header in the theme editor and set the **Logo image**. Adjust **Logo width** until it sits well against your menu. If you leave the logo empty, your store name shows as text instead. You can also set a **Favicon** under *Theme settings → Layout*.
...
Colours are grouped into **schemes** under *Theme settings → Colors*. A scheme holds a background, surface, card, text, and accent colours that work together. Each section then picks which scheme it uses, so you can alternate light and dark bands down a page without editing colours one at a time. Set your brand colours once in the schemes and the whole store follows. See [Theme settings](/docs/customization/theme-settings) for the full breakdown.
...
When your store looks right, return to the theme library and press **Publish**. Infuse becomes your live theme. You can keep editing afterwards, and your changes save as you go.

Stuck on something? The [FAQ](/docs/help/faq) covers common questions, and you can always [contact support](/docs/help/support).
